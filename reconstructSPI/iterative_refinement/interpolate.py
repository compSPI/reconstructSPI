...
def interp_vec(F, r0, r1, dd, N):
    ...
    def fill_vec(F_3d_interp, r0_idx_good, r1_idx_good, F_flat_good, dd):
        ...
        F_3d_interp[r0_idx_good[:, 0], r0_idx_good[:, 1], r0_idx_good[:, -1]] += (
            F_flat_good * dd000
        )  # 000
        F_3d_interp[r1_idx_good[:, 0], r0_idx_good[:, 1], r0_idx_good[:, -1]] += (
            F_flat_good * dd001
        )  # 001
        F_3d_interp[r0_idx_good[:, 0], r1_idx_good[:, 1], r0_idx_good[:, -1]] += (
            F_flat_good * dd010
        )  # 010
        F_3d_interp[r1_idx_good[:, 0], r1_idx_good[:, 1], r0_idx_good[:, -1]] += (
            F_flat_good * dd011
        )  # 011

        F_3d_interp[r0_idx_good[:, 0], r0_idx_good[:, 1], r1_idx_good[:, -1]] += (
            F_flat_good * dd100
        )  # 100
        F_3d_interp[r1_idx_good[:, 0], r0_idx_good[:, 1], r1_idx_good[:, -1]] += (
            F_flat_good * dd101
        )  # 101
        F_3d_interp[r0_idx_good[:, 0], r1_idx_good[:, 1], r1_idx_good[:, -1]] += (
            F_flat_good * dd110
        )  # 110
        F_3d_interp[r1_idx_good[:, 0], r1_idx_good[:, 1], r1_idx_good[:, -1]] += (
            F_flat_good * dd111
        )  # 111
        return F_3d_interp

    F_3d_interp = fill_vec(
        F_3d_interp, r0_idx_good, r1_idx_good, F_flat, dd[:, good_idx]
    )
